...
SELECT SUM(prix) as prix_config FROM Equipement WHERE configuration=1
SELECT SUM(prix) as prix_config FROM Equipement WHERE configuration=2
SELECT SUM(prix) as prix_config FROM Equipement WHERE configuration=3 
SELECT SUM(prix) as prix_config FROM Equipement WHERE configuration=4
